...
function WordSearchController(gameId, listId, solveId, newGameId, instructionsId, themeId) {
	...
	var searchTypes = {
		...
		"Computer Science Job Title!": [["programmer", "game developer", "software management", "ux designer"],
			...
			["game tester", "software developer", "ui designer", "db administrator"]],

		"Branch of Computer Science!": [["kecerdasan artificial", "web programming", "computer network", "ui design"],
			...
			["data analysis", "cloud computing", "operating system", "e bisnis"],
			["data analytics", "blockchain", "arsitektur komputer", "digital forensics"]]
